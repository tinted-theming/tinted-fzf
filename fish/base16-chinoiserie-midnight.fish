...
set -l color08 '#ed5a56'
set -l color09 '#fc8c23'
set -l color0A '#fbb957'
set -l color0B '#aeb831'
set -l color0C '#88b68d'
set -l color0D '#81a2a2'
set -l color0E '#cf8997'
set -l color0F '#cd6227'
