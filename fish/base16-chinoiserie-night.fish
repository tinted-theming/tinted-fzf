...
set -l color08 '#f07c82'
set -l color09 '#f4a83a'
set -l color0A '#f4ce69'
set -l color0B '#b2cf87'
set -l color0C '#b0d5df'
set -l color0D '#8fb2c9'
set -l color0E '#be9db9'
set -l color0F '#b89485'
