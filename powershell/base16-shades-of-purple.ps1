...
--color=bg+:#43d426,bg:#1e1e3f,spinner:#00c5c7,hl:#6943ff
--color=fg:#6871ff,header:#6943ff,info:#ffe700,pointer:#00c5c7
--color=marker:#00c5c7,fg+:#ff77ff,prompt:#ffe700,hl+:#6943ff
"@
