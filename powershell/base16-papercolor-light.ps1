...
--color=bg+:#c4c4c4,bg:#eeeeee,spinner:#0087af,hl:#005f87
--color=fg:#6b6b6b,header:#005f87,info:#d75f00,pointer:#0087af
--color=marker:#0087af,fg+:#525252,prompt:#d75f00,hl+:#005f87
"@
